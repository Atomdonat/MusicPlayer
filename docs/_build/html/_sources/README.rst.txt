...
.. image:: ../pride_versioning.png
    :width: 500
    :alt: It depicts a version number structured as Major.Minor.Patch (e.g., 2.7.123) with custom meanings. The major version ('Proud version') is increased when the developer is proud of the release. The minor version ('Default version') is used for normal or okay releases. The patch version ('Shame version') is incremented when fixing issues that are too embarrassing to admit.
