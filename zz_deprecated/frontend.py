...
class SpotifyAppWindow:
    ...
    def organize_elements(self):
        ...
        self.progress_entry.place(relwidth=0.1125, relheight=label_height*0.75-0.01, relx=0.23125, rely=player_row2_height)
        self.progress_bar.place(relwidth=0.1125, relheight=label_height*0.25, relx=0.23125, rely=player_row2_height+label_height*0.75+0.01)
            ...
            match current_instance.instance['type']:
                ...
                case 'track':
                    self.current_object_info.config(
                        text=backend.value_from_dict(current_instance.album) + ', ' + backend.value_from_dict(current_instance.artist),
                        font=self.normal_font)
